// le, la, les, l'
export const wordReplacementsDefiniteArticles = [
  // le
  { input: "le triangle rouge", output: "Le Triangle Rouge" },
  {
    input: "loki, le détective mythique",
    output: "Loki, le Détective Mythique",
  },
  // la
  ...
  // les
  {
    input: "littlest petshop les aventures",
    output: "Littlest Petshop les Aventures",
  },
...
// un, une, des
export const wordReplacementsIndefiniteArticles = [
  // un
...
// du, de la, de l', des
export const wordReplacementsPartitiveArticles = [
  // du
...
// au, aux, du, des
export const wordReplacementsContractedArticles = [
  // au
...
// ce, cet, cette, ces
export const wordReplacementsDemonstrativeAdjectives = [
  // ce
...
export const wordReplacementsExclamativeAdjectives = [
  // quel
  ...
  // quelles
  {
    input: "elles font quelles recettes",
    output: "Elles Font quelles Recettes",
  },
...
export const wordReplacementsPossessiveAdjectives = [
  // mon
  ...
  // mes
  {
    input: "pourtant mes choix étaient bons",
    output: "Pourtant mes Choix Etaient Bons",
  },
  ...
  // leurs
  {
    input: "jamais sans leurs bicyclettes",
    output: "Jamais sans leurs Bicyclettes",
  },
  {
    input: "leurs régions ont du talents",
    output: "Leurs Régions Ont du Talents",
  },
];
// mais, ou, et, donc, or, ni, car
export const wordReplacementsCoordinatingConjunctions = [
  // mais
  {
    input: "il est studieux mais turbulent",
    output: "Il Est Studieux mais Turbulent",
  },
  ...
  // or
  {
    input: "le temps est chaud or il a froid",
    output: "Le Temps Est Chaud or il A Froid",
  },
...
export const wordReplacementsSubordinatingConjunctions = [
  // que
  ...
  // comme
  {
    input: "elle est belle comme le jour",
    output: "Elle Est Belle comme le Jour",
  },
  ...
  // lorsque
  {
    input: "elle partit lorsque tu arrivas",
    output: "Elle Partit lorsque tu Arrivas",
  },
  { input: "lorsque tu pars", output: "Lorsque tu Pars" },
  // lorsqu
  {
    input: "il partit lorsqu'elle arriva",
    output: "Il Partit lorsqu'elle Arriva",
  },
  { input: "lorsqu'elle arriva", output: "Lorsqu'elle Arriva" },
  // puisque
  {
    input: "il est là puisque je l'ai vu",
    output: "Il Est Là puisque je l'Ai Vu",
  },
  { input: "puisque tu pars", output: "Puisque tu Pars" },
  // puisqu
  {
    input: "ils viennent puisqu'elle part",
    output: "Ils Viennent puisqu'elle Part",
  },
  ...
  // quoiqu
  {
    input: "il l'aime quoiqu'elle fasse",
    output: "Il l'Aime quoiqu'elle Fasse",
  },
...
export const wordReplacementsPrepositions = [
  // à
  ...
  // jusque
  {
    input: "depuis là jusque dans la maison",
    output: "Depuis Là jusque dans la Maison",
  },
  ...
  {
    input: "escales en terres inconnues",
    output: "Escales en Terres Inconnues",
  },
];
// je, tu, il, elle, on, nous, vous, ils, elles, me, te, se, y
export const wordReplacementsPersonalPronouns = [
  // je
  { input: "pourquoi je pleure", output: "Pourquoi je Pleure" },
  { input: "je suis moi", output: "Je Suis Moi" },
  // tu
  {
    input: "toi au moins, tu es mort avant",
    output: "Toi au Moins, tu Es Mort Avant",
  },
  ...
  // elle
  {
    input: "en chemin elle rencontre...",
    output: "En Chemin elle Rencontre...",
  },
  ...
  // me
  {
    input: "laisse moi me prendre en charge",
    output: "Laisse Moi me Prendre en Charge",
  },
  ...
  // se
  {
    input: "il faut se connaître soi-même",
    output: "Il Faut se Connaître Soi-Même",
  },
...
export const wordReplacementsRelativePronouns = [
  // qui
  { input: "ceux qui ont des ailes", output: "Ceux qui Ont des Ailes" },
  { input: "qui est la?", output: "Qui Est La?" },
  // que
  {
    input: "pendant que le roi de prusse...",
    output: "Pendant que le Roi de Prusse...",
  },
  ...
  {
    input: "dont nous aimons la compagnie",
    output: "Dont nous Aimons la Compagnie",
  },
  // où
...
export const wordReplacementswithQuotes = [
  ...
  // t'
  {
    input: "si tu freines t'es un lâche",
    output: "Si tu Freines t'es un Lâche",
  },
  { input: "t'abuses ikko", output: "T'abuses Ikko" },
];
export const wordReplacementsSpecialChars = [
  // -
...
export const upperCaseReplacements = [
  // à
  { input: "motards à jamais", output: "Motards à Jamais" },
  { input: "à toute allure", output: "A Toute Allure" },
  // é
...
export const withNewWords = [
  // tutu
  { input: "mon nouvau texte avec tutu", output: "Mon Nouvau Texte avec tutu" },
  { input: "tutu est arrivé", output: "Tutu Est Arrivé" },
  // toto
  {
    input: "mon nouvau texte avec tutu et tata",
    output: "Mon Nouvau Texte avec tutu et tata",
  },
  { input: "tata et tutu sont là", output: "Tata et tutu Sont Là" },
  // tata
  {
    input: "mon nouvau texte avec tata sans tutu",
    output: "Mon Nouvau Texte avec tata sans tutu",
  },
  {
    input: "Toto se rajoute à tutu et tata",
    output: "Toto se Rajoute à tutu et tata",
  },
];
export const withoutNewWords = [
  // tutu
  { input: "mon nouvau texte avec tutu", output: "Mon Nouvau Texte avec Tutu" },
  { input: "tutu est arrivé", output: "Tutu Est Arrivé" },
  // toto
...
export const keepCapitalizedSpecials = [
  // Ç
